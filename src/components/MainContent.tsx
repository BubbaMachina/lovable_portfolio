      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl">
          ...
          <div className="text-lg text-muted-foreground leading-relaxed space-y-4">
            <p>
              Hello! I am Alex, Currently Working as a Robotics Software Engineer at TechBot Inc. 
              My interests lie in Autonomous Vehicles, Mobile & Legged Robotics, more specifically 
              in the Motion Planning and Controls Domain. I love working with both hardware and software.
            </p>
            <p>
              I received my Master of Engineering in Robotics, from the Massachusetts Institute of 
              Technology in May 2023. I also received my Bachelor of Engineering in Electronics & 
              Electrical Engineering from Stanford University in 2021. Have a look at some of my 
              Projects below!
            </p>
          </div>
        </div>
